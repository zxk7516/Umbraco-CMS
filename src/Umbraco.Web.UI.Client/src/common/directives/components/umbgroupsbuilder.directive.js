(function () {
    ...
    function GroupsBuilderDirective(contentTypeHelper, contentTypeResource, mediaTypeResource, dataTypeHelper, dataTypeResource, $filter, iconHelper, $q, $timeout, notificationsService, localizationService, entityResource) {
        ...
        function link(scope, el, attr, ctrl) {
            ...
            scope.addProperty = function (property, group) {
                ...
                // experiment, just add a property immediately
            ...
            scope.openEditorPickerOverlay = function (property) {
                ...
                scope.editorPickerOverlay.submit = function (model) {
                    scope.model.updateSameDataTypes = model.updateSameDataTypes;

                    scope.focusOnMandatoryField = true;
                    ...
                    // add temp label/alias
                    property.tempAlias = true;
                    property.alias = "temp-alias";
                    property.label = "Enter a name";

                    // code taken from the propertysettings submit method
                    property.inherited = false;
                    property.dialogIsOpen = false;
                    ...
                    // push new init property to group
                    addInitProperty(scope.currentGroup);
