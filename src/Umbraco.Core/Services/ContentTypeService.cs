...
namespace Umbraco.Core.Services
{
    internal class ContentTypeService : ContentTypeServiceBase<ContentTypeRepository, IContentType>, IContentTypeService
    {
        ...
        {
            get { return Constants.ObjectTypes.DocumentTypeGuid; }
        }
...
#pragma warning disable 618 // obsolete
            ...
            Moving += (sender, args) => MovingContentType.RaiseEvent(args, (IContentTypeService)sender);
            Moved += (sender, args) => MovedContentType.RaiseEvent(args, (IContentTypeService)sender);
            ...
            MediaTypeService.Moving += (sender, args) => MovingMediaType.RaiseEvent(args, this /*(IMediaTypeService) sender*/);
            MediaTypeService.Moved += (sender, args) => MovedMediaType.RaiseEvent(args, this /*(IMediaTypeService) sender*/);
#pragma warning restore 618
        ...
        [Obsolete("Use the ContentTypeService.Moving event.", false)]
        public static event TypedEventHandler<IContentTypeService, MoveEventArgs<IContentType>> MovingContentType;
        [Obsolete("Use the ContentTypeService.Moved event.", false)]
        ...
        [Obsolete("Use the MediaTypeService.Moving event.", false)]
        public static event TypedEventHandler<IContentTypeService, MoveEventArgs<IMediaType>> MovingMediaType;
        [Obsolete("Use the MediaTypeService.Moved event.", false)]
