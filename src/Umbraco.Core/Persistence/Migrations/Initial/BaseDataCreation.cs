...
namespace Umbraco.Core.Persistence.Migrations.Initial
{
    ...
    internal class BaseDataCreation
    {
        ...
        private void CreateUmbracNodeData()
        {
            ...
            _database.Insert("umbracoNode", "id", false, new NodeDto { NodeId = Constants.System.ContentTypesLock, Trashed = false, ParentId = -1, UserId = 0, Level = 1, Path = "-1," + Constants.System.ContentTypesLock, SortOrder = 1, UniqueId = new Guid("A88CE058-A627-46BB-878A-07C5FE3D870A"), Text = "LOCK: ContentTypes", NodeObjectType = Constants.ObjectTypes.LockObjectGuid, CreateDate = DateTime.Now });
            _database.Insert("umbracoNode", "id", false, new NodeDto { NodeId = Constants.System.ContentTreeLock, Trashed = false, ParentId = -1, UserId = 0, Level = 1, Path = "-1," + Constants.System.ContentTreeLock, SortOrder = 1, UniqueId = new Guid("3FB9211A-B4F9-449C-8725-A075AE500518"), Text = "LOCK: ContentTree", NodeObjectType = Constants.ObjectTypes.LockObjectGuid, CreateDate = DateTime.Now });
            _database.Insert("umbracoNode", "id", false, new NodeDto { NodeId = Constants.System.MediaTypesLock, Trashed = false, ParentId = -1, UserId = 0, Level = 1, Path = "-1," + Constants.System.MediaTypesLock, SortOrder = 1, UniqueId = new Guid("BA13E02F-E595-4415-8693-B044C83AA9A7"), Text = "LOCK: MediaTypes", NodeObjectType = Constants.ObjectTypes.LockObjectGuid, CreateDate = DateTime.Now });
            _database.Insert("umbracoNode", "id", false, new NodeDto { NodeId = Constants.System.MediaTreeLock, Trashed = false, ParentId = -1, UserId = 0, Level = 1, Path = "-1," + Constants.System.MediaTreeLock, SortOrder = 1, UniqueId = new Guid("5B4408F9-D9FB-4145-84BB-5F0F2C35B4B0"), Text = "LOCK: MediaTree", NodeObjectType = Constants.ObjectTypes.LockObjectGuid, CreateDate = DateTime.Now });
            _database.Insert("umbracoNode", "id", false, new NodeDto { NodeId = Constants.System.MemberTypesLock, Trashed = false, ParentId = -1, UserId = 0, Level = 1, Path = "-1," + Constants.System.MemberTypesLock, SortOrder = 1, UniqueId = new Guid("B23EED6B-CC05-48FE-B096-B50441D0E825"), Text = "LOCK: MemberTypes", NodeObjectType = Constants.ObjectTypes.LockObjectGuid, CreateDate = DateTime.Now });
            _database.Insert("umbracoNode", "id", false, new NodeDto { NodeId = Constants.System.MemberTreeLock, Trashed = false, ParentId = -1, UserId = 0, Level = 1, Path = "-1," + Constants.System.MemberTreeLock, SortOrder = 1, UniqueId = new Guid("FA951390-DF12-4594-8366-89CA8396D977"), Text = "LOCK: MemberTree", NodeObjectType = Constants.ObjectTypes.LockObjectGuid, CreateDate = DateTime.Now });
            _database.Insert("umbracoNode", "id", false, new NodeDto { NodeId = Constants.System.DomainsLock, Trashed = false, ParentId = -1, UserId = 0, Level = 1, Path = "-1," + Constants.System.DomainsLock, SortOrder = 1, UniqueId = new Guid("FE7F0984-6BC9-440E-B105-4B7206B3F6E2"), Text = "LOCK: Domains", NodeObjectType = Constants.ObjectTypes.LockObjectGuid, CreateDate = DateTime.Now });
        }

        private void CreateUmbracoLockData()
        {
            // all lock objects
            _database.Insert("umbracoLock", "id", false, new LockDto { Id = Constants.System.ServersLock });
            _database.Insert("umbracoLock", "id", false, new LockDto { Id = Constants.System.ContentTypesLock });
            _database.Insert("umbracoLock", "id", false, new LockDto { Id = Constants.System.ContentTreeLock });
            _database.Insert("umbracoLock", "id", false, new LockDto { Id = Constants.System.MediaTypesLock });
            _database.Insert("umbracoLock", "id", false, new LockDto { Id = Constants.System.MediaTreeLock });
            _database.Insert("umbracoLock", "id", false, new LockDto { Id = Constants.System.MemberTypesLock });
            _database.Insert("umbracoLock", "id", false, new LockDto { Id = Constants.System.MemberTreeLock });
            _database.Insert("umbracoLock", "id", false, new LockDto { Id = Constants.System.DomainsLock });
        }
