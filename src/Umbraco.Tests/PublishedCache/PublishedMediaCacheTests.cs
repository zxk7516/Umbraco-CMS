...
namespace Umbraco.Tests.PublishedCache
{
    ...
    public class PublishMediaCacheTests : BaseWebTest
	{
		...
		public void Get_Root_Docs()
		{
            ...
            var cache = new PublishedMediaCache(new XmlStore((XmlDocument)null), ctx.Application, new StaticCacheProvider());
		...
		public void Convert_From_Search_Result()
		{
            ...
            var store = new PublishedMediaCache(new XmlStore((XmlDocument)null), ctx.Application, new StaticCacheProvider());
