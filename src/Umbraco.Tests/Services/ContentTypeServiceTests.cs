...
namespace Umbraco.Tests.Services
{
    ...
    public class ContentTypeServiceTests : BaseServiceTest
    {
        ...
        public void Can_Copy_ContentType_By_Performing_Clone()
        {
            ...
            // Act
            var sut = simpleContentType.DeepCloneWithResetIdentities("newcategory") as IContentType;
        ...
        public void Can_Copy_ContentType_To_New_Parent_By_Performing_Clone()
        {
            ...
            // Act
            var clone = simpleContentType.DeepCloneWithResetIdentities("newcategory") as IContentType;
