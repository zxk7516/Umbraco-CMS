    ...
    public class ContentRepositoryTest : BaseDatabaseFactoryTest
    {
        ...
        public void Rebuild_All_Xml_Structures()
        {
            ...
            using (var repository = CreateRepository(unitOfWork, out contentTypeRepository))
            {
                ...
                repository.RebuildContentXml(media => new XElement("test"), 10);
        ...
        public void Rebuild_All_Xml_Structures_For_Content_Type()
        {
            ...
            using (var repository = CreateRepository(unitOfWork, out contentTypeRepository))
            {
                ...
                repository.RebuildContentXml(media => new XElement("test"), 10, contentTypeIds: new[] { contentType1.Id, contentType2.Id });
