...
//        public void SetBranch(int rootContentId, ContentNodeKit[] contentStructs)
//        {
//            if (_frozen == false)
...
//        public void SetAll(ContentNodeKit[] contentStructs)
//        {
//            if (_frozen == false)
...
//        public void SetTypes(IEnumerable<int> contentTypeIds, ContentNodeKit[] contentStructs)
//        {
//            if (_frozen == false)
//                throw new InvalidOperationException("Store is not frozen.");
